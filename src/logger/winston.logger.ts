...
const WinstonLoggerTransportsKey = Symbol();
...
class WinstonLogger implements Logger {
  ...
  public constructor(
    ...
    // console.log(this.getLoggerFormatOptions(transports).format)
    console.log(winston.format.timestamp({
...
export { WinstonLoggerTransportsKey, WinstonLogger }